...
public class CircularImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.hasSelector = attributes.getBoolean(R.styleable.CircularImageView_civ_selector, false);
        int defaultSelectorSize;
        if (this.hasBorder) {
            defaultSelectorSize = (int) (2.0F * context.getResources().getDisplayMetrics().density + 0.5F);
            this.setBorderWidth(attributes.getDimensionPixelOffset(R.styleable.CircularImageView_civ_borderWidth, defaultSelectorSize));
            this.setBorderColor(attributes.getColor(R.styleable.CircularImageView_civ_borderColor, -1));
        }

        if (this.hasSelector) {
            defaultSelectorSize = (int) (2.0F * context.getResources().getDisplayMetrics().density + 0.5F);
            this.setSelectorColor(attributes.getColor(R.styleable.CircularImageView_civ_selectorColor, 0));
            this.setSelectorStrokeWidth(attributes.getDimensionPixelOffset(R.styleable.CircularImageView_civ_selectorStrokeWidth, defaultSelectorSize));
            this.setSelectorStrokeColor(attributes.getColor(R.styleable.CircularImageView_civ_selectorStrokeColor, ContextCompat.getColor(getContext(), android.R.color.transparent)));
        }
    ...
    public void addShadow() {
        this.setLayerType(LAYER_TYPE_SOFTWARE, this.paintBorder);
