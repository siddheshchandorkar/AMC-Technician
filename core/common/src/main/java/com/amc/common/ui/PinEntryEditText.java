...
//            mColors[0] = colorActivated;
            mColors[0] = ContextCompat.getColor(context, R.color.purple_700);

            int colorFocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.purple_200);
            mColors[1] = colorFocused;

            int colorUnfocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.purple_200);
